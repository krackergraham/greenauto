...
requireJsOptimizerConfig = merge(requireJsRuntimeConfig, {
    ...
    include: [
        ...
        'components/contact-page/contact-page',
        'components/gallery-page/gallery-page',
        'components/services-page/services-page',
...
gulp.task('default', ['html', 'js', 'php', 'css', 'images'], function (callback) {
    callback();
